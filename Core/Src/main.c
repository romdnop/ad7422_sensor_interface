...
int main(void)
{
  ...
  if((USER_BUTTON_GPIO_Port->IDR & USER_BUTTON_Pin)) //invert this check after finishing debugging!
  {
    HAL_Delay(100);
    if((USER_BUTTON_GPIO_Port->IDR & USER_BUTTON_Pin))//invert this check after finishing debugging!
    {
...
static void MX_TIM2_Init(void)
{
  ...
  TIM_InitStruct.Autoreload = 2499999;
  ...
  TIM_OC_InitStruct.CompareValue = 1200000;
